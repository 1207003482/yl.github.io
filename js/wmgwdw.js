var rough = (function () {
  ...
  class l {
    ...
    compare(d) {
      ...
      var e = k,
        ...
        n = this.b,
        b = this.c;
      return (1e-5 < i(n) && ((e = -m / n), (g = -b / n)), 1e-5 < i(d.b) && ((f = -d.a / d.b), (l = -d.c / d.b)), e == k)
        ? f == k
          ? -b / m == -d.c / d.a
          ...
          : ((this.xi = this.px1),
            (this.yi = f * this.xi + l),
            -1e-5 > (this.py1 - this.yi) * (this.yi - this.py2) || -1e-5 > (d.py1 - this.yi) * (this.yi - d.py2) ? this.RoughSegmentRelationConst.SEPARATE : 1e-5 > i(d.a) ? (-1e-5 > (d.px1 - this.xi) * (this.xi - d.px2) ? this.RoughSegmentRelationConst.SEPARATE : this.RoughSegmentRelationConst.INTERSECTS) : this.RoughSegmentRelationConst.INTERSECTS)
        : f == k
        ? ((this.xi = d.px1),
          (this.yi = e * this.xi + g),
          -1e-5 > (d.py1 - this.yi) * (this.yi - d.py2) || -1e-5 > (this.py1 - this.yi) * (this.yi - this.py2) ? this.RoughSegmentRelationConst.SEPARATE : 1e-5 > i(m) ? (-1e-5 > (this.px1 - this.xi) * (this.xi - this.px2) ? this.RoughSegmentRelationConst.SEPARATE : this.RoughSegmentRelationConst.INTERSECTS) : this.RoughSegmentRelationConst.INTERSECTS)
        : e == f
        ? g == l
          ? this.px1 >= j(d.px1, d.px2) && this.px1 <= h(d.py1, d.py2)
            ...
            : this.RoughSegmentRelationConst.SEPARATE
          : this.RoughSegmentRelationConst.SEPARATE
        : ((this.xi = (l - g) / (e - f)), (this.yi = e * this.xi + g), -1e-5 > (this.px1 - this.xi) * (this.xi - this.px2) || -1e-5 > (d.px1 - this.xi) * (this.xi - d.px2) ? this.RoughSegmentRelationConst.SEPARATE : this.RoughSegmentRelationConst.INTERSECTS);
    }
    getLength() {
  ...
  class m {
    constructor(a, b, c, d, e, f, g, h) {
      (this.top = a), (this.bottom = b), (this.left = c), (this.right = d), (this.gap = e), (this.sinAngle = f), (this.tanAngle = h), 1e-4 > i(f) ? (this.pos = c + e) : 0.9999 < i(f) ? (this.pos = a + e) : ((this.deltaX = (b - a) * i(h)), (this.pos = c - i(this.deltaX)), (this.hGap = i(e / g)), (this.sLeft = new l(c, b, c, a)), (this.sRight = new l(d, b, d, a)));
    }
    getNextLine() {
  ...
  class p {
    constructor(a, b, c, h, j, k) {
      ...
      var m,
        n = (this._cosPhi * (a[0] - b[0])) / 2 + (this._sinPhi * (a[1] - b[1])) / 2,
    ...
    getNextSegment() {
      ...
      let f = d(this._theta),
        ...
        j = e(h);
      return (
        (c = [this._cosPhi * this._rx * i - this._sinPhi * this._ry * j + this._C[0], this._sinPhi * this._rx * i + this._cosPhi * this._ry * j + this._C[1]]),
        (a = [this._from[0] + this._T * (-this._cosPhi * this._rx * g - this._sinPhi * this._ry * f), this._from[1] + this._T * (-this._sinPhi * this._rx * g + this._cosPhi * this._ry * f)]),
        (b = [c[0] + this._T * (this._cosPhi * this._rx * j + this._sinPhi * this._ry * i), c[1] + this._T * (this._sinPhi * this._rx * j - this._cosPhi * this._ry * i)]),
        (this._theta = h),
        (this._from = [c[0], c[1]]),
        this._segIndex++,
        { cp1: a, cp2: b, to: c }
  ...
  class s {
    ...
    linearPath(a, b, c) {
      ...
      if (2 < d) {
        ...
        return b && (e = e.concat(this._doubleLine(a[d - 1][0], a[d - 1][1], a[0][0], a[0][1], c))), { type: "path", ops: e };
      }
    ...
    ellipse(a, b, c, d, e) {
      ...
      let h = i(c / 2),
        j = i(d / 2);
      (h += this._getOffset(0.05 * -h, 0.05 * h, e)), (j += this._getOffset(0.05 * -j, 0.05 * j, e));
      let k = this._ellipse(g, a, b, h, j, 1, g * this._getOffset(0.1, this._getOffset(0.4, 1, e), e), e),
    ...
    arc(a, b, c, g, h, k, l, m, n) {
      let o = a,
        ...
        q = i(c / 2),
        r = i(g / 2);
      (q += this._getOffset(0.01 * -q, 0.01 * q, n)), (r += this._getOffset(0.01 * -r, 0.01 * r, n));
      let s = h,
        t = k;
      for (; 0 > s; ) (s += 2 * f), (t += 2 * f);
      t - s > 2 * f && ((s = 0), (t = 2 * f));
      let u = (2 * f) / n.curveStepCount,
        ...
        y = w.concat(x);
      return l && (m ? ((y = y.concat(this._doubleLine(o, p, o + q * d(s), p + r * e(s), n))), (y = y.concat(this._doubleLine(o, p, o + q * d(t), p + r * e(t), n)))) : (y.push({ op: "lineTo", data: [o, p] }), y.push({ op: "lineTo", data: [o + q * d(s), p + r * e(s)] }))), { type: "path", ops: y };
    }
    hachureFillArc(a, b, c, g, h, j, k) {
      let l = a,
        ...
        n = i(c / 2),
        o = i(g / 2);
      (n += this._getOffset(0.01 * -n, 0.01 * n, k)), (o += this._getOffset(0.01 * -o, 0.01 * o, k));
      let p = h,
        q = j;
      for (; 0 > p; ) (p += 2 * f), (q += 2 * f);
      q - p > 2 * f && ((p = 0), (q = 2 * f));
    ...
    solidFillShape(a, b, c) {
      ...
      if (a && b && a.length && b.length && a.length === b.length) {
        ...
        if (2 < g) {
          ...
          for (var e = 1; e < g; e++) d.push({ op: "lineTo", data: [a[e] + this._getOffset(-f, f, c), b[e] + this._getOffset(-f, f, c)] });
        }
      }
    ...
    hachureFillEllipse(a, c, d, e, h) {
      let j = [],
        k = i(d / 2),
        l = i(e / 2);
      (k += this._getOffset(0.05 * -k, 0.05 * k, h)), (l += this._getOffset(0.05 * -l, 0.05 * l, h));
    ...
    _bezierTo(a, b, c, d, e, g, h, j) {
      let k = [],
        ...
        m = null;
      for (let f = 0; 2 > f; f++)
        0 === f ? k.push({ op: "move", data: [h.x, h.y] }) : k.push({ op: "move", data: [h.x + this._getOffset(-l[0], l[0], j), h.y + this._getOffset(-l[0], l[0], j)] }),
          (m = [e + this._getOffset(-l[f], l[f], j), g + this._getOffset(-l[f], l[f], j)]),
          k.push({ op: "bcurveTo", data: [a + this._getOffset(-l[f], l[f], j), b + this._getOffset(-l[f], l[f], j), c + this._getOffset(-l[f], l[f], j), d + this._getOffset(-l[f], l[f], j), m[0], m[1]] });
      ...
      switch (b.key) {
        ...
        case "m": {
          ...
          if (2 <= b.data.length) {
            ...
            (f += this._getOffset(-h, h, d)), (g += this._getOffset(-h, h, d)), a.setPosition(f, g), e.push({ op: "move", data: [f, g] });
          }
          break;
        }
        case "L":
        ...
        case "q": {
          ...
          if (4 <= b.data.length) {
            ...
            e.push({ op: "qcurveTo", data: [g + this._getOffset(-k, k, d), h + this._getOffset(-k, k, d), m[0], m[1]] }),
              e.push({ op: "move", data: [a.x + this._getOffset(-l, l, d), a.y + this._getOffset(-l, l, d)] }),
              (m = [i + this._getOffset(-l, l, d), j + this._getOffset(-l, l, d)]),
              e.push({ op: "qcurveTo", data: [g + this._getOffset(-l, l, d), h + this._getOffset(-l, l, d), m[0], m[1]] }),
        ...
        case "t": {
          ...
          if (2 <= b.data.length) {
            ...
            e.push({ op: "qcurveTo", data: [k + this._getOffset(-n, n, d), l + this._getOffset(-n, n, d), p[0], p[1]] }),
              e.push({ op: "move", data: [a.x + this._getOffset(-o, o, d), a.y + this._getOffset(-o, o, d)] }),
              (p = [i + this._getOffset(-o, o, d), j + this._getOffset(-o, o, d)]),
              e.push({ op: "qcurveTo", data: [k + this._getOffset(-o, o, d), l + this._getOffset(-o, o, d), p[0], p[1]] }),
    ...
    _line(a, b, d, e, f, h, i) {
      ...
      let p = [];
      return (
        h && (i ? p.push({ op: "move", data: [a + this._getOffset(-l, l, f), b + this._getOffset(-l, l, f)] }) : p.push({ op: "move", data: [a + this._getOffset(-k, k, f), b + this._getOffset(-k, k, f)] })),
        i
          ? p.push({ op: "bcurveTo", data: [n + a + (d - a) * m + this._getOffset(-l, l, f), o + b + (e - b) * m + this._getOffset(-l, l, f), n + a + 2 * (d - a) * m + this._getOffset(-l, l, f), o + b + 2 * (e - b) * m + this._getOffset(-l, l, f), d + this._getOffset(-l, l, f), e + this._getOffset(-l, l, f)] })
          : p.push({ op: "bcurveTo", data: [n + a + (d - a) * m + this._getOffset(-k, k, f), o + b + (e - b) * m + this._getOffset(-k, k, f), n + a + 2 * (d - a) * m + this._getOffset(-k, k, f), o + b + 2 * (e - b) * m + this._getOffset(-k, k, f), d + this._getOffset(-k, k, f), e + this._getOffset(-k, k, f)] }),
        p
      );
    }
    _curve(a, c, d) {
      ...
      if (3 < e) {
        ...
        for (let c = 1; c + 2 < e; c++) {
          const d = a[c];
          (g[0] = [d[0], d[1]]), (g[1] = [d[0] + (b * a[c + 1][0] - b * a[c - 1][0]) / 6, d[1] + (b * a[c + 1][1] - b * a[c - 1][1]) / 6]), (g[2] = [a[c + 1][0] + (b * a[c][0] - b * a[c + 2][0]) / 6, a[c + 1][1] + (b * a[c][1] - b * a[c + 2][1]) / 6]), (g[3] = [a[c + 1][0], a[c + 1][1]]), f.push({ op: "bcurveTo", data: [g[1][0], g[1][1], g[2][0], g[2][1], g[3][0], g[3][1]] });
        }
        if (c && 2 === c.length) {
          let a = d.maxRandomnessOffset;
          f.push({ ops: "lineTo", data: [c[0] + this._getOffset(-a, a, d), c[1] + +this._getOffset(-a, a, d)] });
        }
      } else 3 === e ? (f.push({ op: "move", data: [a[1][0], a[1][1]] }), f.push({ op: "bcurveTo", data: [a[1][0], a[1][1], a[2][0], a[2][1], a[2][0], a[2][1]] })) : 2 === e && (f = f.concat(this._doubleLine(a[0][0], a[0][1], a[1][0], a[1][1], d)));
      return f;
    }
    _ellipse(a, b, c, g, h, i, j, k) {
      const l = this._getOffset(-0.5, 0.5, k) - f / 2,
        m = [];
      m.push([this._getOffset(-i, i, k) + b + 0.9 * g * d(l - a), this._getOffset(-i, i, k) + c + 0.9 * h * e(l - a)]);
      for (let n = l; n < 2 * f + l - 0.01; n += a) m.push([this._getOffset(-i, i, k) + b + g * d(n), this._getOffset(-i, i, k) + c + h * e(n)]);
      return (
        m.push([this._getOffset(-i, i, k) + b + g * d(l + 2 * f + 0.5 * j), this._getOffset(-i, i, k) + c + h * e(l + 2 * f + 0.5 * j)]),
        m.push([this._getOffset(-i, i, k) + b + 0.98 * g * d(l + j), this._getOffset(-i, i, k) + c + 0.98 * h * e(l + j)]),
        m.push([this._getOffset(-i, i, k) + b + 0.9 * g * d(l + 0.5 * j), this._getOffset(-i, i, k) + c + 0.9 * h * e(l + 0.5 * j)]),
    ...
    _arc(a, b, c, f, g, h, i, j, k) {
      const l = h + this._getOffset(-0.1, 0.1, k),
        m = [];
      m.push([this._getOffset(-j, j, k) + b + 0.9 * f * d(l - a), this._getOffset(-j, j, k) + c + 0.9 * g * e(l - a)]);
  ...
  class t {
    constructor(a, b) {
      (this.config = a || {}), (this.canvas = b), (this.defaultOptions = { maxRandomnessOffset: 2, roughness: 1, bowing: 1, stroke: "#000", strokeWidth: 1, curveTightness: 0, curveStepCount: 9, fill: null, fillStyle: "hachure", fillWeight: -1, hachureAngle: -41, hachureGap: -1 }), this.config.options && (this.defaultOptions = this._options(this.config.options));
    }
    _options(a) {
